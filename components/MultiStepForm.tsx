        ...
        {currentStep === 1 && (
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-base md:text-lg">
              Simply fill in the form to view your sample bank statement layout
            </p>
          </div>
        )}
              ...
              {[
                ...
                <div key={name}>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3 bg-gray-100 border border-gray-300 rounded-full focus:outline-none focus:border-blue-500"
                  />
                </div>
              ))}
